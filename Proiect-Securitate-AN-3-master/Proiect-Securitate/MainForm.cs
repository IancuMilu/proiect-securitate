...
namespace Proiect_Securitate
{
    public partial class MainForm : Form
    {
        ...
        private string pythonPath = @"C:\Users\Iancu\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Python 3.11"; // Path to Python executable
        private string scriptFolderPath = @"G:\Proiect-Securitate-AN-3-master\Proiect-Securitate\scripts";
